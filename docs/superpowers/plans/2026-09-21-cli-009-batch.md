...
- [x] Run grammar tests, global gates; commit `feat: parse deterministic batch filename templates`.
...
- [x] Run `env -u NO_COLOR cargo test -p rs-rich-cli --test batch_paths`; expect unrecognised flags or wrong destinations.
