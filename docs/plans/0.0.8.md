...
The implementation and initial review merged in [PR #189](https://github.com/buchochelliq-labs/rs-rich-cli/pull/189); post-merge CI and docs deployment passed. A fresh review also identified hard-linked batch export aliases, covered by follow-up regression tests. Publication remains a separate gate.
