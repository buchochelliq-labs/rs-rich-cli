...
| #67 / #98 JSON wrapping | Defer. #98 still has P1 feedback about dropped content and default parity; no claim of resolution in this release. |
| #59, #72, #74 and other runtime reports | Defer to separate reproductions and focused fixes; they are outside the selected readiness scope. |
