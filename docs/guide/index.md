...
| `rs-rich-plugin-api` (new in 0.0.12) | `rich_plugin_api`, or `rich_ext::plugin` | The plugin contract: implement `Plugin` to add highlighters, code highlighters, themes, box styles and source renderers. Depends on core only. | [Plugins](https://github.com/buchochelliq-labs/rs-rich-cli/blob/main/docs/PLUGINS.md) |
