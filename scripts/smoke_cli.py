...
CASES: list[Case] = [
    ...
    Case("image-checkerboard", ["image", "logo.png", "--image-mode", "blocks", "--width", "40",
                                "--image-background", "checkerboard"], "▀", art=True),
    Case("image-terminal-bg", ["image", "logo.png", "--image-mode", "blocks", "--width", "40",
                               "--image-background", "default"], "▀", art=True),
    Case("image-atkinson", ["image", "before.png", "--image-mode", "blocks", "--width", "48",
                            "--image-color", "ansi16", "--image-dither", "atkinson",
                            "--image-color-distance", "oklab"], "▀", art=True),
    ...
    Case("theme-file", ["--no-config", "--theme-file", "night.ini", "print", "[notice]Ready[/]"],
         "Ready"),
